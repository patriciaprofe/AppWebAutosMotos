...
(13, 'Citroen C3 2022', 1, 13, 1, '2024-11-11 14:45:23'),
...
ALTER TABLE `publicacion_precios`
  ADD PRIMARY KEY (`id_publicacion`,`fecha`);

--
-- Indices de la tabla `publicacion_imagenes`
--
ALTER TABLE `publicacion_imagenes`
  ADD PRIMARY KEY (`id_publicacion_imagen`);
...
--
-- Filtros para la tabla `publicacion_precios`
--
ALTER TABLE `publicacion_precios`
  ADD CONSTRAINT `producto_precios_ibfk_1` FOREIGN KEY (`id_publicacion`) REFERENCES `productos` (`id_producto`);
